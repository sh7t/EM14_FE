...
const SignInPage = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (isEmpty(password) || !passwordRegexp.test(password)) {
      alert(
        `Entered password must contain at least 8 characters, one number, and one special character!`,
      );
      return;
    }
        ...
        <div className="sign-in-card">
          ...
          <form onSubmit={handleSubmit} className="sign-in-form">
            ...
            <input
              ...
              id="email"
              name="email"
              placeholder="johndoe42@example.com"
              required
            />
          ...
          <h5 className="no-account">
            Don't have an account yet? <a href="/sign_up">Register now</a>
          </h5>
        </div>
      </main>
    </Layout>
