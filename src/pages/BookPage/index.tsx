        ...
        <div className="new-released">
          ...
          <div className="new-released-books-preview">
            {newReleasedBooks.map((newBookWithAuthorName) => (
              <BookPreview
                key={newBookWithAuthorName.id}
                id={newBookWithAuthorName.id}
                title={newBookWithAuthorName.title}
                variant={"buyable"}
                authorName={newBookWithAuthorName.authorName || "Author Name"}
                coverUrl={newBookWithAuthorName.image}
                price={newBookWithAuthorName.price}
              />
            ))}
          </div>
        </div>
